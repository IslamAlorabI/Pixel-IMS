...
- LG U+ (Republic of Korea) and its MVNOs
...
#### Optional (if installing Shizuku using ADB)
...
1. As for now, there are two ways to obtain the application. Choose your favourite way and install the application.
...
AYOR. Tested and checked working only with LG U+ and MVNOs using LG U+ network.
