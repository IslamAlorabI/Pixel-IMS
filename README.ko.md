...
> **Languages:** [English](README.md) | [한국어](README.ko.md) | [العربية](README.ar.md)
...
- LG U+ (대한민국) 및 U+ 통신망을 사용하는 MVNO (알뜰폰)
...
#### 선택 사항 (ADB를 사용하여 Shizuku를 설치하는 경우)
...
### PC 없이 Shizuku 실행 (Wi-Fi 연결 필요)

1. 외부 PC 없이 무선 디버깅을 사용하여 Shizuku를 시작하려면 [공식 가이드](https://shizuku.rikka.app/guide/setup/#start-via-wireless-debugging)를 따르십시오. 이후 Pixel 휴대폰에 "Shizuku is running"과 같은 문구가 표시됩니다.
   <br><img src="https://github.com/kyujin-cho/pixel-volte-patch/raw/main/assets/Screenshot_20230206-035351.png" width="300" />
2. 이제 다음 단계로 이동합니다.

### PC를 사용하여 Shizuku 실행

1. [이 설명](https://shizuku.rikka.app/guide/setup/#start-by-connecting-to-a-computer)에 따라 Pixel 휴대폰을 PC와 연결합니다.
2. `adb shell sh /sdcard/Android/data/moe.shizuku.privileged.api/start.sh` 명령을 실행하여 Shizuku 서비스를 시작합니다. Pixel 휴대폰에 "Shizuku is running"과 같은 문구가 표시되어야 합니다.
...
5. VoLTE가 작동하는 것을 확인할 때 까지 5분 간격으로 2-3회 Pixel 기기를 다시 시작합니다.
...
이 패치에 대해 문의할 사항이 있으시면 다음 기능을 활용해 주세요. 목적을 구분하지 개글 작성의 경우 삭제될 수 있습니다.
